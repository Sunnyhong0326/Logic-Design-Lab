...
set_property PACKAGE_PIN C16 [get_ports {data_to_slave_o[0]}]
...
set_property PACKAGE_PIN A15 [get_ports ack]


set_property PACKAGE_PIN A16 [get_ports {data_to_slave_o[1]}]
set_property PACKAGE_PIN A17 [get_ports request2s]
set_property PACKAGE_PIN B15 [get_ports {data_to_slave_o[2]}]
